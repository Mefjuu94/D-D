...
public class MapRaceTests {
    ...
    //index 1
    private final String outputMapper = "Race{bonuses=[AbilityBonus{name='CON', value=2}], speed=25, size='[\"Medium\"]', languages=[Common, Dwarvish], proficiencies=[Battleaxes, Handaxes, Light hammers, Warhammers]}";
    ...
    MapRace testObject = new MapRace();
