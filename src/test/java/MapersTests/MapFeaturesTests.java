...
public class MapFeaturesTests {
    ...
    //index 2
    private final String outputMapper = "[Feature{name='Bonus Proficiency'}, Feature{name='Disciple of Life'}, Feature{name='Divine Domain'}, Feature{name='Domain Spells'}, Feature{name='Spellcasting: Cleric'}]";
