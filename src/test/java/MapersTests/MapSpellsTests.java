...
public class MapSpellsTests {
    //index 7
    private final String outputMapper = "[Spell{spellName='Alarm'}, Spell{spellName='Animal Friendship'}, Spell{spellName='Cure Wounds'}, Spell{spellName='Detect Magic'}, Spell{spellName='Detect Poison and Disease'}, Spell{spellName='Fog Cloud'}, Spell{spellName='Goodberry'}, Spell{spellName='Hunter's Mark'}, Spell{spellName='Jump'}, Spell{spellName='Longstrider'}, Spell{spellName='Speak with Animals'}]";
