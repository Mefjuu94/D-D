...
public class MapSpellsTests {
    //index 7
    private final String outputMapper = "[Spells{spellName='Alarm'}, Spells{spellName='Animal Friendship'}, Spells{spellName='Cure Wounds'}, Spells{spellName='Detect Magic'}, Spells{spellName='Detect Poison and Disease'}, Spells{spellName='Fog Cloud'}, Spells{spellName='Goodberry'}, Spells{spellName='Hunter's Mark'}, Spells{spellName='Jump'}, Spells{spellName='Longstrider'}, Spells{spellName='Speak with Animals'}]";
