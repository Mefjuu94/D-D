...
public class MapRaceTests {
    ...
    //index 1
    private final String outputMapper = "Race{raceName='\"Dwarf\"', bonuses=[AbilityBonus{bonusName='CON', value=2}], speed=25, size='[\"Medium\"]', languages=[Common, Dwarvish], proficiencies=[Battleaxes, Handaxes, Light hammers, Warhammers]}";
